...
_ISSUE_TYPE_KEY = {
    ...
    "Bug": "bug", "Sub-task": "sub_task", "Other": "other",
}
...
PALETTE = [
    "#4F46E5", "#E8590C", "#0EA5E9", "#D946EF", "#059669",
    "#CA8A04", "#DC2626", "#6D28D9", "#0284C7", "#EA580C",
]
...
def team_workload_data(snapshot: BoardSnapshot, t: Translator | None = None) -> str:
    ...
    return _json({
        "labels": labels,
        "datasets": [
            {"label": t("chart.story_points"), "data": points, "backgroundColor": PALETTE[: len(labels)]},
        ],
    })
